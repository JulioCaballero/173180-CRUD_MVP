 ...
 */
public class SecondFragment extends Fragment implements MainActivityPresent.View{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        tlTabla =  root.findViewById(R.id.tlTablafragment2);
        present = new MainActivityPresent(this);
        present.llenarLista();
        add = root.findViewById(R.id.add2);
        salir = root.findViewById(R.id.salir2);
    ...
    public void dialogDetalles(final User user) {
        ...
        dialog.setButton(AlertDialog.BUTTON_POSITIVE, "Editar", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int id) {
                intent = new Intent(getActivity(), FormSecond.class);
    ...
    public void crearTabla(ArrayList<User> obj){
        ...
        for(int i = -1 ; i < obj.size(); i++) {
            ...
            if(i == -1) {
                ...
                tvEdad = new TextView(getContext());
                tvEdad.setText("Edad");
                tvEdad.setGravity(Gravity.CENTER);
                tvEdad.setBackgroundColor(getResources().getColor(R.color.colorPrimary));
                tvEdad.setTextColor(Color.WHITE);
                tvEdad.setPadding(30, 30, 30, 30);
                ...
                try {
                    ...
                    tvEdad = new TextView(getContext());
                    tvEdad.setGravity(Gravity.CENTER);
                    tvEdad.setText(""+obj.get(i).getEdad());
                    tvEdad.setPadding(30, 30, 30, 30);
