...
import com.example.crud_mvp.Enums.Enums;
import com.example.crud_mvp.Helpers.Helpers;
...
public class User {
    ...
    public User(String nombre, String apellidos, int edad, String sexo, String carrera) {
        this.id = id;
        this.nombre = nombre;
        this.apellidos = apellidos;
        this.edad = edad;
    ...
    public static void deleteAlumnos(final User user,final MainActivityPresent present){
        String mensaje = "";
        HttpClient.delete(Helpers.getBaseUrl()+Enums.getAlumnos()+user.getId(),null,Login.getToken(),
                Enums.getHeader(), new AsyncHttpResponseHandler() {
            @Override
            public void onStart() {
                // called before request is started
            ...
            public void onSuccess(int statusCode, Header[] headers, byte[] responseBody) {
               ...
               //         Toast.makeText(principal, "Eliminacion exitosa", Toast.LENGTH_LONG).show();
                //        getAlumnos();
                        present.notificacionEliminar(user.getNombre()+" fue eliminado con exito",true);
                    } catch (Exception e) {
                        e.printStackTrace();
                    }
                }
    ...
    public static void updateAlumnos(final User usuario,final FormPresent present){
        RequestParams params = new RequestParams();
        params.put("nombre", usuario.getNombre());
        params.put("apellidos", usuario.getApellidos());
        params.put("edad", usuario.getEdad());
        params.put("sexo", usuario.getSexo());
        params.put("carrera", usuario.getCarrera());
        HttpClient.put(Helpers.getBaseUrl()+Enums.getAlumnos()+usuario.getId(),params,Login.getToken(),
                Enums.getHeader(), new AsyncHttpResponseHandler() {
            @Override
            public void onStart() {
                // called before request is started
            ...
            public void onSuccess(int statusCode, Header[] headers, byte[] responseBody) {
                ...
                if(statusCode == 200){
                    ...
                    //    Toast.makeText(principal, "Actualizacion exitosa", Toast.LENGTH_LONG).show();
                     //   getAlumnos();
                        present.notificacionActualizacion("Actualización realizada con exito",true);
                    } catch (Exception e) {
                        e.printStackTrace();
                    }
                }
    ...
    public static void postAlumnos(final User usuario, final FormPresent present){
        RequestParams params = new RequestParams();
        params.put("nombre", usuario.getNombre());
        params.put("apellidos", usuario.getApellidos());
        params.put("edad", usuario.getEdad());
        params.put("sexo", usuario.getSexo());
        params.put("carrera", usuario.getCarrera());
        HttpClient.postAlumnos(Helpers.getBaseUrl()+Enums.getAlumnos(),params,Login.getToken(),
                Enums.getHeader(), new AsyncHttpResponseHandler() {
            @Override
            public void onStart() {
                // called before request is started
            ...
            public void onSuccess(int statusCode, Header[] headers, byte[] responseBody) {
                ...
                if(statusCode == 200){
                    try {
                     ...
                     //   getAlumnos();
                        present.notificacionGuardado("Se ha registrado con exito",true);
                    } catch (Exception e) {
                        e.printStackTrace();
                    }
                }
    ...
    public static void getAlumnoByIDForm(final int id,final FormPresent present){
        user = null;
        HttpClient.getByid(id,Helpers.getBaseUrl()+Enums.getAlumnos(),null,Login.getToken(),
                Enums.getHeader(), new AsyncHttpResponseHandler() {
                    @Override
